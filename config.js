...
const SITE_CONFIG = {
  ...
  // ------------------------------------------------------------
  rsvpFormEmbedUrl: "COLE_AQUI_O_LINK_DE_INCORPORAR_DO_GOOGLE_FORMS",
  rsvpFormDirectUrl: "COLE_AQUI_O_LINK_NORMAL_DO_GOOGLE_FORMS", // link "Enviar" simples, usado no botão alternativo
